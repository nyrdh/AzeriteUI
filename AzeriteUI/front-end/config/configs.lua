...
RegisterLayoutVariation("BlizzardObjectivesTracker", "Legacy", "Azerite", (IsAnyClassic) and {
	["FontObject"] = GetFont(13, true),
	["FontObjectTitle"] = GetFont(15, true),
	["HideInBossFights"] = true,
	["HideInCombat"] = false,
...
RegisterLayout("Minimap", "Azerite", {
	...
	["BlipTextures"] =
		...
		(IsWrath) and
			setmetatable({
			--}, { __index = function(t,k) return [[Interface\Minimap\objecticons.blp]] end }) or
			}, { __index = function(t,k) return [[Interface\Minimap\ObjectIconsAtlas.blp]] end }) or
		(IsRetail) and
			setmetatable({
...
RegisterLayout("UnitFramePlayer", "Azerite", {
	...
	["HardenedLevel"] = (IsAnyClassic) and 40 or 30,
